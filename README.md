...
Overall, working in a team throughout the entire process of making a game has been a very enlighting experience. As team manager, the biggest challange was to keep everyone excited about the project and motivated to come to the meetings. Nevertheless, constantly revising our progress and adjusting the scope of the project was definitely enabled us to deliver a game that we were all content with.
